...
2. Determined which papers had full-text or PDFs available (*n*=432).
3. Evaluated each paper to determine which had extractable data or had summaries of data presented elsewhere (*n*=28).
...
![Developmental time course of mean grating acuity (in cyc/deg) for typically developing children as assessed by two types of Teller Acuity Cards, TAC-I (purple circles) and TAC-II (yellow triangles) and *loess* fits.](include/generated/fig-typical-group-LT3y-by-card-type-weight-n-no-classic-no-viridis-1.png)

\

![Relationship between the standard deviation (SD in octaves) of estimated visual acuity (cyc/deg) observed in typically developing children as assessed by Teller Acuity Cards and child age in months for both card types: TAC-I (red circles) and TAC-II (cyan triangles).](include/generated/fig-typical-group-sd-by-age-default-style-color-1.png)
...
- Variation in mean acuity thresholds at different ages and by card type pose challenges for norm and standard-setting [@Neijzen2025-ak].
