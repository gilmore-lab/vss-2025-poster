...
```{r}
#| label: fig-typical-group-sd-by-age-default
#| fig-cap: "Relationship between the standard deviation (SD in octaves) of estimated visual acuity (cyc/deg) observed in typically developing children as assessed by Teller Acuity Cards and child age in months for both card types: TAC-I (purple circles) and TAC-II (yellow triangles)."
